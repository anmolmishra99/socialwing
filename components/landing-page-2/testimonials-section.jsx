export const TestimonialsSection = () => (
  <section className="proof-section">
    <style jsx>{`
      ...
      .testi:hover { background: rgba(255,255,255,0.08); }
      .testi-quote {
      ...
      .testi-name { font-weight: 600; font-size: 0.9rem; color: var(--paper); }
      .testi-role { font-size: 0.78rem; color: rgba(245,241,235,0.45); }
      .stars { color: var(--gold); font-size: 0.75rem; margin-bottom: 16px; }
    ...
    <div className="container">
      ...
      <h2 className="section-title">Results from founders <em>like you</em></h2>

      <div className="testimonials">
        <div className="testi reveal">
          <div className="stars">★★★★★</div>
          <p className="testi-quote">"My team literally asked if I hired a ghostwriter. I told them yes — one that costs less than a lunch and never misses a deadline."</p>
          <div className="testi-author">
            <div className="testi-avatar">AK</div>
            <div>
              <div className="testi-name">Ankit K.</div>
              <div className="testi-role">Founder, EdTech startup · 8.2K followers</div>
            </div>
          </div>
        </div>
        ...
        <div className="testi reveal">
          ...
          <div className="testi-author">
            ...
            <div>
              ...
              <div className="testi-role">VP Sales, B2B SaaS · 14.1K followers</div>
            </div>
          </div>
        </div>
        ...
        <div className="testi reveal">
          ...
          <div className="testi-author">
            ...
            <div>
              ...
              <div className="testi-role">CEO, MarTech agency · 22K followers</div>
            </div>
          </div>
        </div>
      </div>
